    ...
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-32 pb-20">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/10 border border-primary-foreground/20 backdrop-blur-md text-primary-foreground/90 text-xs uppercase tracking-[0.22em] mb-8 reveal-up">
            <ShieldCheck className="w-3.5 h-3.5 text-teal" />
            Consultoría empresarial certificada
          </div>

          <h1 className="font-display text-primary-foreground text-balance text-5xl md:text-6xl lg:text-7xl leading-[1.05] mb-6 reveal-up" style={{ animationDelay: "0.1s" }}>
            Estrategia, cumplimiento <br />
            y <span className="italic text-teal">excelencia</span> para tu organización.
          </h1>

          <p className="text-primary-foreground/80 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed reveal-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 reveal-up" style={{ animationDelay: "0.3s" }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-6 md:gap-12 mt-16 max-w-2xl reveal-up" style={{ animationDelay: "0.4s" }}>
            {[
              { n: "+15", l: "Años de experiencia" },
              { n: "+200", l: "Empresas asesoradas" },
              { n: "100%", l: "Compromiso con resultados" },
            ].map((s) => (
              <div key={s.l} className="border-l-2 border-teal/60 pl-4">
                <div className="font-display text-3xl md:text-4xl text-primary-foreground">{s.n}</div>
